...
export class Player extends Phaser.Physics.Arcade.Sprite {
  ...
  public setDpadDirection(dir: string) {
  ...
  update() {
    ...
    const isLeft =
      cursors.left.isDown || cursors.a.isDown || this.dpadDirection === 'left';
    const isRight =
      cursors.right.isDown ||
      cursors.d.isDown ||
      this.dpadDirection === 'right';
    const isUp =
      cursors.up.isDown || cursors.w.isDown || this.dpadDirection === 'up';
    const isDown =
      cursors.down.isDown || cursors.s.isDown || this.dpadDirection === 'down';

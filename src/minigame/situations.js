...
export const PHASE_CONFIGS = {
  phase_1: {
    ...
    mcNarration: "Bạn vừa mở shop trên Sàn S. Mọi thứ tuyệt vời: sách tri thức đầy bản đồ, bẫy ít và chậm. Hãy kiếm thật nhiều tiền!",
    maxBooks: 10,
    trapCount: 2,
    trapSpeed: 3.5,
  ...
  phase_2: {
    ...
    mcNarration: "Sàn đã nắm thế độc quyền. Phí sàn bắt đầu tự động trừ vào vốn các bạn mỗi 10 giây. Cảm nhận được sự khác biệt chưa?",
    maxBooks: 5,
    trapCount: 4,
    trapSpeed: 5.5,
  ...
  phase_3: {
    ...
    mcNarration: "Đây là thực tế hàng triệu người bán nhỏ lẻ trên Shopee, Grab đang phải đối mặt mỗi ngày. Liệu bạn có sống sót?",
    maxBooks: 3,
    trapCount: 6,
    trapSpeed: 7.5,
